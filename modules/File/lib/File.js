...
function File(path) {
     ...
     */
    this.pathSeparator = this.file.pathSeparator;
     ...
     */
    this.separatorChar = this.file.separatorChar;
}
...
decaf.extend(File.prototype, {
    ...
    /**
     * Phyiscally copy a file to a new file, or overwrite an existing file.
     *
